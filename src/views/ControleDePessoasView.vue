<template>
          ...
          <tbody>
            ...
            <tr v-for="item in pessoas" :key="item.id">
              ...
              <td class="icon-tabela"> 
                <i @click="editarPessoa(item)"> Editar </i> | 
                <i @click="excluirPessoa(item)"> Excluir </i>
              </td>
            </tr>
  ...
  export default {
    ...
    data(){
      ...
      //     axios
      // .get('http://194.163.44.230:8000/api/pessoa')
      // .then(response => this.pessoas = response.data.data.celular)
      //     console.log(this.pessoas)
